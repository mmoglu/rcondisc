...
#'
#' rcondisc assesses convergent and discriminant validity of latent constructs
...
#'
#' rcondisc applies a strict criterion supporting discriminant validity only when
